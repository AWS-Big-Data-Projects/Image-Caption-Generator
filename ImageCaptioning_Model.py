...
bucket='projectdata27'
key='project.pkl'
pickle_byte_obj = pickle.dumps([wordtoix,ixtoword,max_length]) 
...
temp = descriptions['1000268201_693b08cb0e']
image = bucket.Object('data/data/Images/'+'1000268201_693b08cb0e.jpg')
...
client.upload_file(Filename='modelR.h5',
                  Bucket="projectdata27",
                  Key='modelR.h5')
...
model3.fit([X1,X2], y, epochs=60, batch_size=256, callbacks=callbacks_list)

client = boto3.client('s3')
client.upload_file(Filename='model4.h5',
                  Bucket="projectdata27",
                  Key='model4.h5')
